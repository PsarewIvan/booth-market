...
//                 <span className="order__name">{this.props.name}</span>
//                 <span className="order__size">
//                   <BoothSize size={this.props.size} />
//                 </span>
//               </p>
//               <p className="order__item-cost">{`${Math.round(
//                 this.props.boothCost / 100
//               )} ₽`}</p>
//             </div>
//             <div className="order__rental">
//               <RentalTime
//                 rentalTimes={this.props.rentalTimes}
//                 inputName="order-rental"
//                 checkedId={this.props.rentalId}
...
//               <Button name="Отправить заявку" onClick={this.props.closeOrder} />
//             </div>
//           </div>
//         </div>
//       </section>
